...
<html lang="en">
    <head>
        ...
        <title>Spark Bank Service</title>
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="80">
        ...
        <nav class="navbar navbar-default navbar-fixed-top before-color">
            <div class="container">
                <div class="navbar-header">
                   ...
                   <div clas="c">
                    <a class="navbar-brand alo" href="index.php" >Spark Bank Service</a></div>
        </div>
            ...
            <div class="tp-banner">
                ...
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500">
                        <!-- MAIN IMAGE -->
                        <img src="bank05.jpg" alt="desk" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 text-center">
                        <div class="section-title">
                            <h1> <span class="alo">Digital Banking</span></h1> 
                            <span class="border-line"></span>
                            <p class="lead subtitle-caption">
                                we provide banking service in which you can stay at home for making transactions, savings, withdrawl and other functionalities.
                            </p>
                        </div>
                    </div>
                </div><!-- title row end-->
                    ...
                    <div class="col-sm-6 margin-bottom30">
                        <div class="feature-icon-wrap clearfix">
                            ...
                            <div class="features-text-right">
                                ...
                                <p>
                                    Our user friendly environment provides you comfortable way of banking at your own pace.
                                </p>
                            </div>
                    ...
                    <div class="col-sm-6 margin-bottom30">
                        <div class="feature-icon-wrap clearfix">
                            ...
                            <div class="features-text-right">
                                <h3>Great support</h3>                         
                                <p>
                                    We provide 24x7 support in which you can shoot your queries and get suggestions and ansewers from our dedicated team
                                </p>
                            </div>
                        </div><!--features icon wrap-->
                    </div><!--features col-->
                    ...
                    <div class="col-sm-6 margin-bottom30">
                        <div class="feature-icon-wrap clearfix">
                            ...
                            <div class="features-text-right">
                                <h3> Trustworthy</h3>                         
                                <p>
                                    We care for your security and our system of banking is trustworthy.
                                </p>
                            </div>
                        </div><!--features icon wrap-->
                    </div><!--features col-->
                    <div class="col-sm-6 margin-bottom30">
                        <div class="feature-icon-wrap clearfix">
                            ...
                            <div class="features-text-right">
                                ...
                                <p>
                                   Our dedicated team will guide through your future investment plan, secure banking, savings etc.
                                </p>
                            </div>
                        </div><!--features icon wrap-->
                    </div><!--features col-->
        ...
        <footer class="footer">
            <div class="container text-center">
                <span class="alo">Spark Bank Service</span>
